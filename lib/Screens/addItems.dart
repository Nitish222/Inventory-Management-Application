...
class addItemsState extends State<addItems>{
  ...
  TextEditingController medicineBrandController;
  TextEditingController batchQuantityController;
  void initState(){
    super.initState();
    medicineNameController = TextEditingController();
    medicineBrandController = TextEditingController();
                    ...
                    onPressed: () async {
                      if(_formKey.currentState.validate()) {
                        ...
                        await Database().addMedicine(
                          Quantity: int.parse(batchQuantityController.text),
                          brandName: medicineBrandController.text,
